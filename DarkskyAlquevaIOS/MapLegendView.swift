...
class MapLegendView: UIView {
    ...
    func addView(){
        ...
        self.titleLabel = UILabel(frame: CGRect(x: 10, y: 5, width: 140, height: 20))
        self.titleLabel.font = self.titleLabel.font.withSize(14)
        //self.titleLabel.textAlignment = .center
        self.addSubview(self.titleLabel)

        
        self.markerOneImageView = UIImageView(frame: CGRect(x: 0, y: 30, width: 40, height: 40))
        self.markerOneImageView.contentMode = .scaleAspectFit
        self.markerOneTitle = UILabel(frame: CGRect(x: 40, y: 40, width: 120, height: 20))
        ...
        self.markerTwoImageView = UIImageView(frame: CGRect(x: 0, y: 65, width: 40, height: 40))
        self.markerTwoImageView.contentMode = .scaleAspectFit
        self.markerTwoTitle  = UILabel(frame: CGRect(x: 40, y: 75, width: 120, height: 20))
        ...
        self.markerThreeImageView = UIImageView(frame: CGRect(x: 0, y: 100, width: 40, height: 40))
        self.markerThreeImageView.contentMode = .scaleAspectFit
        self.markerThreeTitle  = UILabel(frame: CGRect(x: 40, y: 110, width: 120, height: 20))
